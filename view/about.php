...
<head>
	...
	<!-- title -->
	<title>About FruitOnWheels</title>
			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 text-center">
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								<li href="index_2.php"><a href="index_2.php">Home</a>
									<!-- <ul class="sub-menu">
										<li><a href="index.php">Static Home</a></li>
										<li><a href="index_2.php">Slider Home</a></li>
									</ul> -->
								</li>
								<li class="current-list-item"><a href="#" class="current-list-item">About</a></li>
								<!-- <li><a href="#">Pages</a>
									<ul class="sub-menu">
			...
			<div class="row">
				<div class="col-lg-7">
					<div class="featured-text">
						<h2 class="pb-3">Why <span class="orange-text">FruitOnWheels</span></h2>
						<div class="row">
							<div class="col-lg-6 col-md-6 mb-4 mb-md-5">
								<div class="list-box d-flex">
									...
									<div class="content">
										<h3>Fresh Fruits</h3>
										<p>We provide you with health fresh fruit at your door-step.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 mb-5 mb-md-5">
								<div class="list-box d-flex">
									...
									<div class="content">
										<h3>Best Price</h3>
										<p>Affordable prices for all our fruits, juice,smoothies and popsicles.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 mb-5 mb-md-5">
								<div class="list-box d-flex">
									...
									<div class="content">
										...
										<p>Nicely and neatly packaging for all our products.sit voluptatem accusantium dolore mque laudantium, totam rem aperiam, eaque ipsa quae ab illo.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6">
								<div class="list-box d-flex">
									...
									<div class="content">
										<h3>Assorted Fruits Products</h3>
										<p>We serve you with all kinds of fruit product such as fruit juice, fresh fruits, popsicles and smoothies.</p>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="section-title">
						...
						<p>Working hard to always brining you the best</p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<div class="single-team-item">
						...
						<h4>Naa Korliki Ologo Gyan <span>Ceo</span></h4>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-team-item">
						...
						<h4>Richida Opoku Gyimah <span>Ceo</span></h4>
						<ul class="social-link-team">
							<li><a href="https://www.facebook.com/fruits.onwheels.1" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
							<li><a href="https://www.instagram.com/fruitswheels/?hl=en" target="_blank"><i class="fab fa-twitter"></i></a></li>
							<li><a href="#" target="_blank"><i class="fab fa-instagram"></i></a></li>
						</ul>
					</div>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-12">
					<p>Copyrights &copy; 2022 - <a href="https://imransdesign.com/">LindaArthur</a>,  All Rights Reserved.<br>
						</a>
					</p>
				</div>
